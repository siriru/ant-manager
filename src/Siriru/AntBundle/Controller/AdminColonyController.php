...
class AdminColonyController extends Controller
{
     ...
     *
     * @Route("/colonies", name="colony_create")
     * @Method("POST")
     ...
     *
     * @Route("/colony/new", name="colony_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/colony/{id}/edit", name="colony_edit")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/colony/{id}", name="colony_update")
     * @Method("PUT")
     ...
     *
     * @Route("/colony/{id}", name="colony_delete")
     * @Method("DELETE")
     */
